...
Class TestTool
    ...
    Public Sub New()
        MyBase.New(DVTKActor.PDS, UPS_Scenario.UpsCompletedOrCanceled)
    End Sub

    Public Overrides Function GetScenarioToRun() As Scenario
        Return New ReceiveUPSCompletedOrCanceled()
    End Function
...
Module DvtkScript
    ...
    Sub Main(ByVal CmdArgs() As String)
        ...
        TesttoolRunner.RunTool(New TestTool(), TesttoolRunner.TestSessionFileName_IPDW_UPS_TMS)
