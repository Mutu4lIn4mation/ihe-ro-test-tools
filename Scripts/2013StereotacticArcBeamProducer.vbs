...
Class TestTool
    ...
    Protected Overrides Sub Execute()
        ...
        m_scenarioRunner.RunScenario(New BeamScenarioProducer(ARTO_Scenario.StereotacticArcBeam))
...
Module DvtkScript
    ...
    Sub Main(ByVal CmdArgs() As String)
        ...
        TesttoolRunner.RunTool(New TestTool(), TesttoolRunner.TestSessionFileName_RTA)        
